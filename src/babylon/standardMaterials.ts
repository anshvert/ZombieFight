...
export class StandardMaterials {
    ...
    CreateGroundMaterial():StandardMaterial {
        ...
        const diffuseTex = new Texture("./textures/cobblestone/cobblestone_diffuse.jpg", this.scene)
        ...
        texArray.push(aoTex)
        const specTex = new Texture("./textures/cobblestone/cobblestone_spec.jpg", this.scene)
